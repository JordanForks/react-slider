...
var ReactSlider = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.forceValueFromPosition = function forceValueFromPosition(position, callback) {
    ...
    for (var _i = 0; _i < value.length - 1; _i += 1) {
      if (value[_i + 1] - value[_i] > this.props.maxDistance) {
        return;
      }
    }
  ...
  _proto.renderThumbs = function renderThumbs(offset) {
    ...
    for (var _i2 = 0; _i2 < length; _i2 += 1) {
      res[_i2] = this.renderThumb(styles[_i2], _i2);
    }
...
ReactSlider.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  maxDistance: _propTypes.default.number,
   ...
   */
  marks: _propTypes.default.oneOfType([_propTypes.default.arrayOf(_propTypes.default.number), _propTypes.default.bool, _propTypes.default.number]),
